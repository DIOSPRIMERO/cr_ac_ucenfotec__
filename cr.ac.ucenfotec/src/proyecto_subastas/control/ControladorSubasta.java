...
public class ControladorSubasta {
     ...
     * objetos de negocio directamente. La creación queda centralizada
     ...
     * @param anioCompra  Año de compra del objeto.
    ...
    public ObjetoSubasta crearObjeto(String nombre, String descripcion,
                                     String estado, int anioCompra) {
        return new ObjetoSubasta(nombre, descripcion, estado, anioCompra);
    }

    /**
     * Crea una nueva subasta en el sistema aplicando todas las reglas de negocio.
     * <p>
     * Valida que el creador no sea moderador, que la lista de objetos no esté vacía,
     * y que si el creador es un coleccionista, los objetos pertenezcan a su colección.
     * </p>
     *
     ...
     * @param fechaVencimiento Fecha límite de la subasta en formato dd/mm/aaaa.
    ...
    public String crearSubasta(Usuario creador, ArrayList<ObjetoSubasta> objetos,
        ...
        // objetos registrados en su colección personal.
     ...
     * <p>
     * Valida que la subasta exista y esté activa, que el oferente sea un coleccionista,
     * que no sea el creador de la subasta, y que el monto supere el precio mínimo.
     * </p>
     *
     ...
     *
     * @return Cadena con la información de cada subasta, o un mensaje indicando
     *         que no hay subastas registradas.
     */
     ...
     *
     * @return Cadena con las ofertas de cada subasta, o un mensaje indicando
     *         que no hay ofertas registradas.
     */
